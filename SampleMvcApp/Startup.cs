    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, IOptions<AppSettings> appSettings)
        {
            ...
            var options = new OpenIdConnectOptions("Auth0")
            {
                ...
                Authority = $"https://{appSettings.Value.Auth0.Domain}",

                // Configure the Auth0 Client ID and Client Secret
                ClientId = appSettings.Value.Auth0.ClientId,
                ClientSecret = appSettings.Value.Auth0.ClientSecret,
                ...
                Events = new OpenIdConnectEvents
                {
                    ...
                    {
                        var logoutUri = $"https://{appSettings.Value.Auth0.Domain}/v2/logout?client_id={appSettings.Value.Auth0.ClientId}";
